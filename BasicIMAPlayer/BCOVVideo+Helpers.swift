...
extension BCOVVideo {
    ...
    func updateVideo(useAdTagsInCuePoints: Bool) -> BCOVVideo? {
        ...
        if useAdTagsInCuePoints {
            preRollProperties = [kBCOVIMAAdTag:PlayerConfig.IMAConfig.VASTAdTagURL_preroll]
            midRollProperties = [kBCOVIMAAdTag:PlayerConfig.IMAConfig.VASTAdTagURL_midroll]
            postRollProperties = [kBCOVIMAAdTag:PlayerConfig.IMAConfig.VASTAdTagURL_postroll]
        }
